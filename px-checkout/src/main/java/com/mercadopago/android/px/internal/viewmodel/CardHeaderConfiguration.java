...
import com.mercadolibre.android.card.header.configuration.SecurityCodeLocation;
import com.mercadolibre.android.card.header.configuration.font.FontType;
import com.mercadolibre.android.card.header.model.CardAnimationType;
import com.mercadolibre.android.card.header.model.CardUI;
import com.mercadopago.android.px.model.CardDisplayInfo;
import java.io.Serializable;

public class CardHeaderConfiguration implements CardUI, Serializable {
    ...
    public CardHeaderConfiguration(final CardDisplayInfo info) {
        this.info = info;
